...
%attr(-,root,root) /mnt/opt/hadoop-infinite/rpms/hue-1.2.0.0+114.20-1.noarch.rpm
...
%attr(-,root,root) /mnt/opt/hadoop-infinite/rpms/hue-plugins-1.2.0.0+114.20-1.noarch.rpm
...
# Nano webserver
###########################################################################
%attr(-,root,root) /mnt/opt/hadoop-infinite/webroot/nano.jar
